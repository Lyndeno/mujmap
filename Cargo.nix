...
in {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".atty."0.2.14" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${
        ...
        rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.124" {inherit profileName;};
      ${
  ...
  "registry+https://github.com/rust-lang/crates.io-index".clap."3.1.14" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "535434c063ced786eb04aaf529308092c5ab60889e8fe24275d15de07b01fa97";
    };
    features = builtins.concatLists [
      ["atty"]
      ["cargo"]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".clap-verbosity-flag."1.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "17e437250f23cdd03daf3de763093aa27873a026ef9a156800da9ddd617c51d4";
    };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".const_format."0.2.22" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "22bc6cd49b0ec407b680c3e380182b6ac63b73991cb7602de350352fc309b614";
    };
    features = builtins.concatLists [
      ["default"]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".email-parser."0.5.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "fd45adbcbe4247e0a92f13ae66d10b11a6fc05f6184a8f573755afab21f18799";
    };
    features = builtins.concatLists [
      ["bcc"]
      ["cc"]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".fqdn."0.1.9" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "9b4b9cc8d7db413f35e3647159e2f726741d605522b7de6f2c59056da0badf79";
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".from_variants."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "221a1eb1a3c98980bc1b740f462b3dcf73f4e371cda294986bac72497995a4e3";
    };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".from_variants_impl."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "7e08079fa3c89edec9160ceaa9e7172785468c26c053d12924cce0d5a55c241a";
    };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ipconfig."0.3.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${
        ...
        rustPackages."registry+https://github.com/rust-lang/crates.io-index".widestring."0.5.1" {inherit profileName;};
      ${
        if hostPlatform.isWindows
        then "winapi"
        else null
      ...
      ${
        ...
        rustPackages."registry+https://github.com/rust-lang/crates.io-index".winreg."0.7.0" {inherit profileName;};
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".loe."0.3.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "7ee56338292b3ed2891f11425b4824c43e3b50d41300185b9487a425c5dab4ca";
    };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".notmuch."0.8.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "e25d11a2449f4f91cb71b138b241db30765a3b2f595eba0dd6a282b0e961dd44";
    };
    features = builtins.concatLists [
      ["default"]
      ["v0_21"]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ring."0.16.20" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${
        ...
        rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.10.0" {inherit profileName;};
      ${
      ...
      ${
        ...
        rustPackages."registry+https://github.com/rust-lang/crates.io-index".web-sys."0.3.57" {inherit profileName;};
      ${
        if hostPlatform.parsed.kernel.name == "windows"
        then "winapi"
        else null
  ...
  "registry+https://github.com/rust-lang/crates.io-index".snafu."0.7.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "2eba135d2c579aa65364522eb78590cdf703176ef71ad4c32b00f58f7afb2df5";
    };
    features = builtins.concatLists [
      ["default"]
      ["rust_1_46"]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".snafu-derive."0.7.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "7a7fe9b0669ef117c5cabc5549638528f36771f058ff977d7689deb517833a75";
    };
    features = builtins.concatLists [
      ["rust_1_46"]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".trust-dns-resolver."0.21.2" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${
        ...
        rustPackages."registry+https://github.com/rust-lang/crates.io-index".ipconfig."0.3.0" {inherit profileName;};
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.4.0" {inherit profileName;};
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.16" {inherit profileName;};
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ureq."2.4.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "9399fa2f927a3d327187cbd201480cee55bee6ac5d3c77dd27f0c6814cff16d5";
    };
    features = builtins.concatLists [
      ["default"]
      ["flate2"]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".uritemplate-next."0.2.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "bcde98d1fc3f528255b1ecb22fb688ee0d23deb672a8c57127df10b98b4bd18c";
    };
    dependencies = {
      regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.5.5" {inherit profileName;};
    };
